...
import {IconCross32, createClassName, IconButton, Text, IconChevronLeft32} from '@create-figma-plugin/ui'
import { useEffect, useRef } from 'preact/hooks'

import { createFocusTrapKeyDownHandler } from '../../utilities/create-focus-trap-key-down-handler.js'
